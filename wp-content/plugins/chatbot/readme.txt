...
> <strong>OpenAI GPT-3 or ChatGPT</strong> is supported as a module for WPBot Pro version. OpenAI’s API provides access to GPT3 (ChatGPT), for a wide variety of natural language tasks.
