...
define('QCLD_wpCHATBOT_VERSION', '4.5.1');
...
<div class="wrap swpm-admin-menu-wrap">
  ...
  <a class="nav-tab sld_click_handle nav-tab-active"  href="#general_int">Getting Started</a> 

  <a class="nav-tab sld_click_handle" id="general_debuggings"  href="#general_debugging">Troubleshooting & FAQ</a> 

  </h2>
 
 
<!--  <div class="container wppt-settings-section" style="margin-right:unset;margin-left:unset; margin-top:40px" id="general_help">
    <div class="content form-container qcbot_help_secion" style="padding: 10px;color:#fff">
      <h3 style="font-size:20px;margin-top: 10px;">Check out the Pro version of the Plugin for more features from <a href="https://www.wpbot.pro/" target="_blank">here</a>.</h3>
    </div>
  </div>-->
  
  
  
  <div class="container wppt-settings-section" style="margin-right:unset;margin-left:unset; display:block; margin-top:40px" id="general_int">
    <div class="content form-container qcbot_help_secion" style=""> 
      ...
      <div class="panel panel-default">
            ...
            <div class="panel-heading" role="tab" id="headingThree">
                <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> <?php esc_html_e('DialogFlow ES and CX, OpenAI', 'wpbot'); ?> </a>
                </h4>
            </div>
