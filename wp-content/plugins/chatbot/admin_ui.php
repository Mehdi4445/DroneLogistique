      ...
      <div class="<?php esc_attr_e( 'wp-chatbot-tabs wp-chatbot-tabs-style-flip',  'wpbot' );  ?> ">
        ...
        <div class="<?php esc_attr_e( 'content-wrap',  'wpbot' );  ?>">
          ...
          <div class="<?php esc_attr_e( 'cxsc-settings-blocks-notic',  'wpbot' );  ?> ">
            <p class="<?php esc_attr_e( 'd-ib',  'wpbot' );  ?> "><?php esc_html_e('Please see the plugin`s Getting Started section for how to create interactions.', 'wpbot'); ?>
            <p class="<?php esc_attr_e( 'd-ib',  'wpbot' );  ?> "><?php esc_html_e('The ChatBot can work with ANY language. Just change the language texts from the ChatBot Settings->Language Center.', 'wpbot'); ?>
            <p class="<?php esc_attr_e( 'd-ib',  'wpbot' );  ?> "><?php esc_html_e('Please see the plugin`s Help and Debugging section to troubleshoot common issues.', 'wpbot'); ?>
                          ...
                          <ul class="<?php esc_attr_e( 'checkbox-list',  'wpbot' );  ?> ">
                            ...
                            <li>
                              <input
                                      ...
                                      value="<?php esc_attr_e( '$post_type->name', 'wpbot'); ?>" <?php if (!empty($wp_chatbot_exclude_post_list) && in_array($post_type->name, $wp_chatbot_exclude_post_list) == true) {
                                  echo esc_attr('checked');
                              } ?> >
                            <label
                ...
                <div class="<?php esc_attr_e( 'top-section',  'wpbot' );  ?> ">
                  <div class="<?php esc_attr_e( 'row',  'wpbot' );  ?> ">
                    <div class="<?php esc_attr_e( 'col-xs-12',  'wpbot' );  ?> ">
                      <div class="<?php esc_attr_e( 'row',  'wpbot' );  ?> ">
                        <div class="<?php esc_attr_e( 'col-xs-12',  'wpbot' );  ?> ">
                          <p class="<?php esc_attr_e( 'wpqcld_chk_seft',  'wpbot' );  ?> "> <a target="_blank" href="<?php echo esc_url('https://www.quantumcloud.com/products/themes/chatbot-theme/',  'wpbot' );  ?> "><img src="<?php echo esc_url(QCLD_wpCHATBOT_IMG_URL) ?>/chatbot-theme.jpg" alt="" /></a> </p>
                        </div>
                      </div>
                      <h4 class="<?php esc_attr_e( 'qc-opt-title',  'wpbot' );  ?> ">
