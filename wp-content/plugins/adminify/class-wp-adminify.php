...
if ( !class_exists( 'WP_Adminify' ) ) {
    class WP_Adminify
    {
        ...
        {
            add_action( 'plugins_loaded', [ $this, 'maybe_run_upgrades' ], -100 );
            ...
            // jltwp_adminify()->add_filter( 'plugin_icon' , [ $this, 'jltwp_adminify_logo_icon' ] );
        ...
        public function jltwp_adminify_logo_icon()
        {
