...
class AdminifyPromo
{
    ...
    public function jltwp_adminify_latest_update_details()
    {
        ...
        $jltwp_adminify_changelog_message = sprintf(
            ...
            // %3$s
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Call to undefined method Freemius_Api_WordPress::RemoteRequest() PHP fatal error issue fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Tested on WordPress version 6.2 </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Custom CSS active sub menu color and menu background color not working issue fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> "Phlox WordPress Theme" & "Stackable – Page Builder Gutenberg Blocks" plugins support for hidden adminbar issue fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Logo text in dark/light mode issue fixed </span><br>', 'adminify' )
        );
